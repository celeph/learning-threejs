...
import polelightVertexShader from './shaders/polelight/vertex.glsl'
import polelightFragmentShader from './shaders/polelight/fragment.glsl'
...
const poleLightMaterial = new THREE.ShaderMaterial({ 
  vertexShader: polelightVertexShader,
  fragmentShader: polelightFragmentShader
})
...
debugObject.portalColorStart = '#af1f1f'
debugObject.portalColorEnd = '#ffffff'

const portalLightMaterial = new THREE.ShaderMaterial({
  uniforms: {
    uTime: { value: 0 },
    // uColorStart: { value: new THREE.Color(0xdc8383) },
...
gltfLoader.load(
    ...
    (gltf) =>
    {
        ...
        const bakedMesh = gltf.scene.children.find((child) => child.name === 'Cube068');
